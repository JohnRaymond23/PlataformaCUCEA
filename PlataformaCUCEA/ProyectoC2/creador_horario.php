    ...
    <?php include 'user_header.php'; ?>
        ...
        <div class="container w-100 separate">
            ...
            <div class="d-flex justify-content-center">
                <a href="schedule.php" class="btn btn-primary btn-lg" style="font-size: 14px;">Ir a mi horario</a>
            </div>

                <div class="table-responsive">
                        <!-- Inicio - Buscador Test -->
                        <div class="container">
                            <h2 class="mb-3">Buscador de materias</h2>
                        <form method="POST">
                                <div class="input-group w-100">
                                    <input type="text" name="Buscar" class="form-control" style="font-size: 14px;" placeholder="Buscar" autocomplete="off">
                                        ...
                                        while($data=mysqli_fetch_array($query))     
                                        {
                                            ...
                                            <div class="accordion-item"> 
                                                ...
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <div idcurso="<?php echo $data['idcurso'] ?>" draggable="true" ondragstart="event.dataTransfer.setData('text/plain',null)" style="font-size: 16px; width: 100%; border: none;margin-bottom: 2px;padding: 5px;border-radius:4px;"><?php echo $data['nombre']; ?></div>
                                                </button>
                                                </h2>
